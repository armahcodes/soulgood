/**
 * Take Out is the published Square Online menu, separate from our meal-plan cart.
...
export const EAT_NOW = {
  ...
  deliveryDetails:
    "Take Out orders may be delivered by on-demand courier partners such as Uber Direct or DoorDash, or by a Soul Good courier, depending on availability.",
  coverage:
  ...
  availability:
    "Check the menu for current items, service times, and pickup or delivery options. Courier availability and delivery coverage depend on your address. Review tax, courier fees, and your total at Take Out checkout before paying.",
} as const;
