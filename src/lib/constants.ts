...
export const RECIPES: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      "2 tbsp tahini",
      "1 tbsp lemon juice",
      "1 tsp Soul Good seasoning blend",
      "Salt and pepper to taste",
    ],
    instructions: [
      "Cook quinoa in water according to package directions. Let cool slightly.",
      "Preheat oven to 400°F. Toss sweet potato cubes with olive oil, salt, and pepper. Roast for 20 minutes until tender.",
      "Whisk together tahini, lemon juice, Soul Good seasoning, and 2 tablespoons of warm water to make the dressing.",
      "Divide quinoa between two bowls.",
      "Arrange roasted sweet potato, purple cabbage, cherry tomatoes, avocado, broccoli, and carrots in sections over the quinoa.",
  ...
  },
  {
    ...
    instructions: [
      "Heat oat milk in a small saucepan over medium heat until warm but not boiling.",
      "Add turmeric, ginger, cinnamon, black pepper, and coconut oil. Whisk to combine.",
      "Simmer on low for 3–4 minutes, stirring occasionally.",
      "Remove from heat and stir in honey or maple syrup.",
      "Strain into a mug if desired, or serve as-is for extra texture.",
      "Dust with a pinch of cinnamon on top and enjoy warm.",
    ],
  },
  {
    id: "recipe-3",
    ...
    instructions: [
      "Pat fish dry and coat evenly with blackening seasoning on both sides.",
      "Prepare mango slaw by tossing diced mango, red cabbage, cilantro, jalapeño, and juice of 1 lime in a bowl. Season with salt.",
      "Make avocado crema by blending avocado, Greek yogurt, remaining lime juice, and a pinch of salt until smooth.",
      "Heat olive oil in a skillet over medium-high heat. Cook fish for 3–4 minutes per side until blackened and cooked through.",
      "Warm tortillas in a dry skillet or over an open flame for 15 seconds each side.",
      "Break fish into chunks and divide among tortillas. Top with mango slaw and a drizzle of avocado crema.",
    ],
  },
  {
    id: "recipe-4",
    ...
    instructions: [
      "Blanch collard green leaves in boiling water for 30 seconds to soften. Transfer to an ice bath and pat dry.",
      "Season cooked quinoa with cumin, olive oil, lemon juice, salt, and pepper.",
      "Lay each collard leaf flat and spread a thin layer of herbed hummus down the center.",
      "Add seasoned quinoa, roasted bell peppers, shredded carrots, and red onion on top of the hummus.",
      "Fold the sides of the leaf in, then roll tightly from bottom to top, like a burrito.",
      "Slice in half diagonally and serve with extra hummus on the side.",
    ],
  },
  {
    id: "recipe-5",
    ...
    instructions: [
      ...
      "Add sweet potato cubes, turmeric, cayenne, salt, and pepper. Stir to coat.",
      ...
      "Taste and adjust seasoning. Serve topped with fresh cilantro and toasted pumpkin seeds.",
    ],
  },
  {
    id: "recipe-6",
    ...
    instructions: [
      ...
      "In a small bowl, mix parsley, dill, chives, and panko breadcrumbs together.",
      "Prepare citrus glaze by whisking lemon juice, orange juice, lemon zest, orange zest, and honey together.",
      "Season salmon fillets with salt and pepper. Brush the top of each fillet with Dijon mustard.",
      "Press the herb-breadcrumb mixture firmly onto the mustard-coated surface of each fillet.",
      "Place salmon on the baking sheet and drizzle with olive oil. Bake for 12–15 minutes until the crust is golden and fish flakes easily.",
      "Drizzle with citrus glaze and serve with roasted vegetables or a fresh salad.",
    ],
  },
  {
    id: "recipe-7",
    ...
    ingredients: [
      ...
      "1 tbsp chia seeds",
      "Toppings: granola, fresh berries, sliced banana, coconut flakes, hemp seeds",
    ],
    instructions: [
      "Add frozen berries, frozen banana, almond milk, ashwagandha powder, and almond butter to a high-speed blender.",
      "Blend on low, using a tamper to push ingredients down, until thick and creamy. The consistency should be thicker than a smoothie.",
      "Pour into a bowl and smooth the top with a spoon.",
      "Arrange toppings in rows: granola, fresh berries, sliced banana, coconut flakes, hemp seeds, and chia seeds.",
      "Serve immediately for the best thick, creamy texture.",
    ],
  },
  {
    id: "recipe-8",
    ...
    instructions: [
      ...
      "In a large bowl, toss cauliflower florets with olive oil, jerk seasoning, smoked paprika, garlic powder, onion powder, cayenne, and salt.",
      "Spread cauliflower in a single layer on the baking sheet, ensuring pieces don't overlap.",
      "Roast for 20–25 minutes, flipping halfway through, until edges are crispy and golden brown.",
      "While cauliflower roasts, whisk together tahini, lemon juice, and water until smooth. Add more water if needed for drizzling consistency.",
      "Transfer roasted cauliflower to a serving plate, drizzle with tahini dip, and garnish with fresh parsley.",
    ],
  },
  {
    id: "recipe-9",
    ...
    instructions: [
      ...
      "Remove tough stems from kale. Core the apples and peel the lemon.",
      "Cut cucumber, apples, and celery into pieces that fit your juicer chute.",
      "Feed all ingredients through the juicer, alternating leafy greens with harder produce for best extraction.",
      "Stir the juice well and pour over ice into two glasses.",
      "Serve immediately for maximum nutrient benefit. Can be stored in an airtight container in the fridge for up to 24 hours.",
    ],
  },
];
